 ...
 */
package com.fastjrun.jeecgboot.service.helper;
...
public class MockHelper {
    ...
    public static PageResult<Boolean> geBooleanPage(int maxSize) {
        ...
        pageResult.setRecords(booleans);
        pageResult.setCurrent(RandomUtils.nextInt());
        pageResult.setSize(RandomUtils.nextInt());
        pageResult.setPages(RandomUtils.nextInt());
